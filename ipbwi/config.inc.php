<?php
	...
	if(!defined('ipbwi_BOARD_PATH')){
		define('ipbwi_BOARD_PATH','/var/www/forums/');
	}
	...
	if(!defined('ipbwi_ROOT_PATH')){
		define('ipbwi_ROOT_PATH','/var/www/website/ipbwi/');
	}
	...
	if(!defined('ipbwi_WEB_URL')){
		define('ipbwi_WEB_URL','http://anguishps.com/website/');
	}
	...
	if(!defined('ipbwi_COOKIE_DOMAIN')){
		define('ipbwi_COOKIE_DOMAIN','.anguishps.com');
	}
